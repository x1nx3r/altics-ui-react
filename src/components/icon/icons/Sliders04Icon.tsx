...
export type Sliders04IconProps = SVGProps<SVGSVGElement> & {
  size?: number;
};

export function Sliders04Icon({ size = 24, ...props }: Sliders04IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
Sliders04Icon.displayName = "Sliders04Icon";
