...
export type SearchLgIconProps = SVGProps<SVGSVGElement> & {
  size?: number;
};

export function SearchLgIcon({ size = 24, ...props }: SearchLgIconProps) {
  return (
    <svg
      width={size}
      height={size}
