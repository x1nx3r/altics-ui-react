...
export type ZoomOutIconProps = SVGProps<SVGSVGElement> & {
  size?: number;
};

export function ZoomOutIcon({ size = 24, ...props }: ZoomOutIconProps) {
  return (
    <svg
      width={size}
      height={size}
