...
export type SlashCircle01IconProps = SVGProps<SVGSVGElement> & {
  size?: number;
};

export function SlashCircle01Icon({ size = 24, ...props }: SlashCircle01IconProps) {
  return (
    <svg
      width={size}
      height={size}
