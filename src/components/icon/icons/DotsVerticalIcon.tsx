...
export type DotsVerticalIconProps = SVGProps<SVGSVGElement> & {
  size?: number;
};

export function DotsVerticalIcon({ size = 24, ...props }: DotsVerticalIconProps) {
  return (
    <svg
      width={size}
      height={size}
