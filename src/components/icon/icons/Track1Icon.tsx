...
export type Track1IconProps = SVGProps<SVGSVGElement> & {
  size?: number;
};

export function Track1Icon({ size = 24, ...props }: Track1IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
Track1Icon.displayName = "Track1Icon";
