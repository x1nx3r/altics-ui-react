...
export type PalletAlt1IconProps = SVGProps<SVGSVGElement> & {
  size?: number;
};

export function PalletAlt1Icon({ size = 24, ...props }: PalletAlt1IconProps) {
  return (
    <svg
      width={size}
      height={size}
