...
export type Thermometer01IconProps = SVGProps<SVGSVGElement> & {
  size?: number;
};

export function Thermometer01Icon({ size = 24, ...props }: Thermometer01IconProps) {
  return (
    <svg
      width={size}
      height={size}
