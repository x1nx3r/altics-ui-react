...
export type Disc01IconProps = SVGProps<SVGSVGElement> & {
  size?: number;
};

export function Disc01Icon({ size = 24, ...props }: Disc01IconProps) {
  return (
    <svg
      width={size}
      height={size}
