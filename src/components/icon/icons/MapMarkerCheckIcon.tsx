...
export type MapMarkerCheckIconProps = SVGProps<SVGSVGElement> & {
  size?: number;
};

export function MapMarkerCheckIcon({ size = 24, ...props }: MapMarkerCheckIconProps) {
  return (
    <svg
      width={size}
      height={size}
